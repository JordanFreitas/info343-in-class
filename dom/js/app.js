...
console.log(numeral(BABYNAMES.length).format("0,0")); //number of elemebets in the array using numeral.js

//"closure" -- access to all variables and paramters of the function
...
console.log("clicked col headder");
